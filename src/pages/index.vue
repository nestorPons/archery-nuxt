...
<template>
    <div class="flex flex-col items-center">
        ...
        <form @submit.prevent="submitForm" class="">
            <div class="component">
                <label for="edad" class="mb-2">{{ $text('Age') }}:</label>
            ...
            <div class="component">
                <div class="width-arrow">
                    <label for="longitud" class="mb-2">{{  $text('Arrow Length') }}:</label>
        ...
        <div class="border-2 drop-shadow p-5 w-100 ">
            <p>Edad: {{ edad }}</p>
            <p>Longitud: {{ longitudes }}</p>
            <p>Unidad de longitud: {{ textChangeUnit }}</p>
